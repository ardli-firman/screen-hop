"""Settings dialog for browser_move application."""

import customtkinter as ctk
from pathlib import Path
from typing import Callable, Any, Optional

from src.browser_move.config import load_config, save_config, CONFIG_PATH


class SettingsWindow:
    """Settings modal dialog for browser move automation."""
    ...
    def toggle_startup(self) -> None:
        ...
        msg = ctk.CTkLabel(
            feedback_frame,
            text=f"Application {action} startup!",
            font=ctk.CTkFont(size=14),
        )
        msg.pack(pady=20)
